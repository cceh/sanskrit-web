...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="entry" select="/rails:variables/rails:lemma/rails:entry/tei:entry"/>
...
-->
	...
	<xsl:template name="raw-tei">
		<details>
			<summary>
				<xsl:text>[click to show TEI code…]</xsl:text>
			</summary>
			<pre>
				<code>
					<xsl:apply-templates select="$entry" mode="serialize"/>
				</code>
			</pre>
		</details>
	</xsl:template>
